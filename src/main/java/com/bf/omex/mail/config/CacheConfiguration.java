package com.bf.omex.mail.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("omexMail");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("omexMail");
        ...
        config.getMapConfigs().put("com.bf.omex.mail.domain.*", initializeDomainMapConfig(jHipsterProperties));
