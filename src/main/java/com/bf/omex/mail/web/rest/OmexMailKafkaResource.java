...
@RestController
@RequestMapping("/api/omex-mail-kafka")
public class OmexMailKafkaResource {
    private final Logger log = LoggerFactory.getLogger(OmexMailKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OmexMailKafkaResource(KafkaProperties kafkaProperties) {
